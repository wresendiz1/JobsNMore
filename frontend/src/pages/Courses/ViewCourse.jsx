        ...
        {course && (
            <MainLayout>
                ...
                <Container className="min-vh-100">
                    <Row>
                        <Card>
                            <Card.Header className="text-center"> Course Information </Card.Header>
                            <Card.Body className="text-center">
                                <Card.Title>{course.Name}</Card.Title>
                                <Card.Subtitle className="mb-2 text-muted">{course.Type}</Card.Subtitle>
                                <ListGroup className="list-group-flush">
                                    <ListGroupItem>Provider: {course.Provider}</ListGroupItem>
                                    <ListGroupItem>Description: {course.Description}</ListGroupItem>
                                    <ListGroupItem>Take Course: 
                                    <a className="mx-2" href={course.Url} target="_blank" rel="noopener noreferrer">Link</a>
                                    </ListGroupItem>
                                </ListGroup>
                            </Card.Body>
                        </Card>

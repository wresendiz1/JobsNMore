...
function Home() {
  ...
  const checkShape = (e) => {
    ...
    const clickedShapeDict = pages.find((page) => Object.keys(page)[0] === e.target.title);
      ...
      <div id="container">
        <div id="box" ref={clickBox}>
          {pages.map((page, index) => (
            <div role="button" tabIndex={index} className="shape hvr-reveal" title={Object.keys(page)[0]} key={Object.keys(page)[0]} onClick={checkShape} onKeyUp={checkShape}>
